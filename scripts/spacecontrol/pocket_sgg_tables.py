...
open("tables/pocket_sgg.tex", "w").write(
    ...
    "\\bottomrule\n\\end{tabular}\n\\caption{Top pass rushers by Space Generation Gain (SGG). "
    "Att.\\ is the rusher's front-normalized blocking attention, PFF press his own "
    "pressure rate, and $+/-$ his plus-minus effect. The leading generators are interior "
