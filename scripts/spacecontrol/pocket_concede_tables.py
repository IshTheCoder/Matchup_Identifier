...
open("tables/pocket_concede_flow.tex", "w").write(
    ...
    "\\emph{releasing} blocker to a \\emph{receiving} blocker (a pass-off), summed over eight weeks. "
    "These are the offensive-line pairs whose hand-offs on stunts and twists most often leak "
