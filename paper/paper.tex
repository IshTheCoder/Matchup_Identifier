...
We fit the play-level model on all eight weeks of data (8{,}531 plays, 36{,}259 rusher observations) with the No-U-Turn sampler implemented using NumPyro.  We rank rushers, restricting our attention to rushers with at least 50 pass snaps over the sample.  This removes the rare blitzers with high variance estimates (e.g. defensive backs who rush on a handful of plays).
...
We also are able to rank quarterbacks by their STRAIN allowed, as evidenced by \ref{tab:qb_suppression}. 
